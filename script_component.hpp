...
#define COMPONENT OPTRE_ACE_Compat
...
#ifdef DEBUG_ENABLED_OPTRE_ACE_Compat
    #define DEBUG_MODE_FULL
#endif

#ifdef DEBUG_SETTINGS_OPTRE_ACE_Compat
    #define DEBUG_SETTINGS DEBUG_SETTINGS_OPTRE_ACE_Compat
#endif
